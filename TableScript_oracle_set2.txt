...
Insert into JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID)values (114,to_date('24-MAR-98','DD-MON-RR'),to_date('31-DEC-99','DD-MON-RR'),'ST_CLERK',50);
Insert into JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID)values (122,to_date('01-JAN-99','DD-MON-RR'),to_date('31-DEC-99','DD-MON-RR'),'ST_CLERK',50);
